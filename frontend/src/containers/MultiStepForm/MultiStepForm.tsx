...
export default function MultiStepForm() {
  ...
  // Target
  const [targetUsers, setTargetUsers] = React.useState<TargetType[]>([]);
  // for create
    ...
    >
      ...
      <Grid xs={6}>
        ...
        <React.Fragment>
          ...
          {activeStep === 2 ? <TargetUserStep notificationType={notificationType} targetName={targetName} setTargetName={setTargetName} endpoint={endpoint} setEndpoint={setEndpoint} data={data} setData={setData} targetUsers={targetUsers} setTargetUsers={setTargetUsers} /> : null}
          {activeStep === 3 ? <ReservationStep message={message!} targets={targetUsers!} notificationType={notificationType} handleRecurrenceChange={setRecurrence}  /> : null}
